...
namespace Arikan
{
    ...
    public static class TextureUtil
    {
        ...
        public static Texture2D AddWatermark(this Texture2D background, Texture2D watermark, WatermarkPose pose)
        {
            int startX = 0;
            int startY = 0;
            switch (pose)
            {
                case WatermarkPose.BottomLeft:
                    startX = 0;
                    startY = 0;
                    break;
                case WatermarkPose.BottomRight:
                    startX = background.width - watermark.width;
                    startY = 0;
                    break;
                case WatermarkPose.TopLeft:
                    startX = 0;
                    startY = background.height - watermark.height;
                    break;
                case WatermarkPose.TopRight:
                    startX = background.width - watermark.width;
                    startY = background.height - watermark.height;
                    break;
            }
