...
namespace UnityToolbag
{
    ...
    {
        [MenuItem("Arikan/Generate UnityConstants.cs")]
        public static void Generate()
        {
            ...
            if (string.IsNullOrEmpty(filePath)) {
                string directory = EditorUtility.OpenFolderPanel("Choose location for Constants.cs", Application.dataPath+ "/Arikan/Scripts/", "");
            ...
            using (var writer = new StreamWriter(filePath)) {
                ...
                writer.WriteLine();
                writer.WriteLine("namespace Constants");
                writer.WriteLine("{");
